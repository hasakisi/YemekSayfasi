...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="auto-style1">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="TxtMalzemeler" runat="server" Height="75px" TextMode="MultiLine" Width="250px" CssClass="tb5"></asp:TextBox>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="auto-style8">
                <asp:Button ID="BtnTarifOner" runat="server" Height="38px" Text="Tarif Öner" Width="254px" OnClick="BtnTarifOner_Click" CssClass="fb8" />
            </td>
        </tr>
    </table>
</asp:Content>
