            ...
            <table class="auto-style1" style="height: 364px">
                <tr>
                    <td class="auto-style6"><strong>
                        <asp:Label ID="Label3" runat="server" style="font-size: large" Text='<%# Eval("GununYemegiAd") %>'></asp:Label>
                        </strong></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="text-align: center; margin-left: 40px" class="auto-style5">
                        <asp:Image ID="Image1" runat="server" Height="187px" Width="320px" ImageUrl="~/resimler/pizza.jpg" />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="auto-style4" style="margin-left: 40px"><strong>Puan</strong>:<asp:Label ID="Label8" runat="server" Text='<%# Eval("GununYemegiPuan") %>'></asp:Label>
                        &nbsp;&nbsp;&nbsp;&nbsp; -&nbsp;&nbsp;&nbsp; <strong>&nbsp;&nbsp; Eklenme Tarih</strong>:<asp:Label ID="Label9" runat="server" Text='<%# Eval("GununYemegiTarih") %>'></asp:Label>
                    </td>
                </tr>
                <tr>
